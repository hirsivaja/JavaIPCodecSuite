...
public record AddressMaskReply(short identifier, short sequenceNumber, int addressMask) implements IcmpMessage {
    ...
    public static IcmpMessage decode(ByteBuffer in) {
        ...
        return new AddressMaskReply(identifier, sequenceNumber, addressMask);
    }

    @Override
    public IcmpType type() {
        return IcmpTypes.ADDRESS_MASK_REPLY;
    }

    @Override
    public IcmpCode code() {
        return IcmpCodes.ADDRESS_MASK_REPLY;
    }
}
