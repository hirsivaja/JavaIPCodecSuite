...
public class HopByHopExtension implements ExtensionHeader {
    private final IpProtocol nextHeader;
    private final short options;
    private final int padding;
    private final byte[] extraOptions;

    public HopByHopExtension(IpProtocol nextHeader, short options, int padding, byte[] extraOptions) {
    ...
    public static ExtensionHeader decode(ByteBuffer in) {
        ...
        in.get(extraOptions);
        return new HopByHopExtension(nextHeader, options, padding, extraOptions);
    }
