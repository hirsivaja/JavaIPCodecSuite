...
public record DuplicateAddressConfirmation(byte status, short registrationLifetime, long eui64, Ipv6Address registeredAddress) implements Icmpv6Message {
    ...
    public static Icmpv6Message decode(ByteBuffer in) {
        ...
        return new DuplicateAddressConfirmation(status, registrationLifetime, eui64, registeredAddress);
    }

    @Override
    public Icmpv6Type type() {
        return Icmpv6Types.DUPLICATE_ADDRESS_CONFIRMATION;
    }

    @Override
    public Icmpv6Code code() {
        return Icmpv6Codes.DUPLICATE_ADDRESS_CONFIRMATION;
    }
}
