...
public record InverseNeighborDiscoveryAdvertisement(List<NdpOption> options) implements Icmpv6Message {
    ...
    public static Icmpv6Message decode(ByteBuffer in) {
        ...
        return new InverseNeighborDiscoveryAdvertisement(options);
    }

    @Override
    public Icmpv6Type type() {
        return Icmpv6Types.INVERSE_NEIGHBOR_DISCOVERY_ADVERTISEMENT;
    }

    @Override
    public Icmpv6Code code() {
        return Icmpv6Codes.INVERSE_NEIGHBOR_DISCOVERY_ADVERTISEMENT_MESSAGE;
    }
}
