...
public class Ipv6HeaderTest {
    ...
    public void codecTest() {
        ...
        Assert.assertArrayEquals(IpUtils.parseHexBinary("3FFE050700000001020086FFFE0580DA"), header.getSourceAddress().getAddress());
        Assert.assertArrayEquals(IpUtils.parseHexBinary("3FFE05010410000002C0DFFFFE47033E"), header.getDestinationAddress().getAddress());
