...
public class Ipv6HeaderTest {
    ...
    public void codecTest() {
        ...
        Assert.assertEquals((byte) 0x00, header.getTrafficClass());
    ...
    public void pseudoHeaderTest() {
        ...
        Ipv6Header ipv6Header = new Ipv6Header((byte) 0, 0, len, nextHeader, (byte) 0, sourceAddress, destinationAddress);
