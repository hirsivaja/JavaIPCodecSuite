...
public class Ipv6AddressTest {
    ...
    public void addressTest() {
        byte[] ipv6AddressBytes = TestUtils.parseHexBinary("0102030405060708090A0B0C0D0E0F00");
        ...
        ipv6AddressBytes = TestUtils.parseHexBinary("00000000000000000000000000000000");
        ...
        ipv6AddressBytes = TestUtils.parseHexBinary("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF");
        address = Ipv6Address.decode(ByteBuffer.wrap(ipv6AddressBytes));
        Assert.assertEquals(16, address.getLength());
        Assert.assertArrayEquals(ipv6AddressBytes, address.getAddress());
        Assert.assertArrayEquals(ipv6AddressBytes, address.toInetAddress().getAddress());
    ...
    public void invalidAddressTest() {
        byte[] tooFewBytes = TestUtils.parseHexBinary("01020304");
        ...
        byte[] tooManyBytes = TestUtils.parseHexBinary("0102030405060708090A0B0C0D0E0F0001020304");
