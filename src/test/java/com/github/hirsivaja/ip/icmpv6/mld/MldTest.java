...
public class MldTest {
    ...
    public void queryV1Test() {
        byte[] headerBytes = TestUtils.parseHexBinary("6000000000240001FE800000000000000000000000000001FF0200000000000000000000000000013A00010005020000");
        byte[] msg = TestUtils.parseHexBinary("82003C0303E800000102030405060708090A0B0C0D0E0F00");
    ...
    public void queryV2Test() {
        byte[] headerBytes = TestUtils.parseHexBinary("6000000000240001FE800000000000000000000000000001FF0200000000000000000000000000013A00010005020000");
        byte[] msg = TestUtils.parseHexBinary("820079FF03E8000000000000000000000000000000000000023C0000");
    ...
    public void reportV2Test() {
        byte[] headerBytes = TestUtils.parseHexBinary("60000000004C0001FE800000000000007C3BE33937631C08FF0200000000000000000000000000163A00050200000100");
        byte[] msg = TestUtils.parseHexBinary("8F00E0D70000000304000000FF0200000000000000000001FF76BA4204000000FF0200000000000000000000000000FB04000000FF0200000000000000000001FF631C08");
